...
from cassandra_dask_dataframe.config import config

# Enable debug logging for thread pool
logging.getLogger("cassandra_dask_dataframe.thread_pool").setLevel(logging.DEBUG)
    ...
    async def test_idle_threads_are_cleaned_up(self, session, test_table_name):
        ...
        try:
            ...
            try:
                ...
                from cassandra_dask_dataframe.reader import CassandraDataFrameReader
